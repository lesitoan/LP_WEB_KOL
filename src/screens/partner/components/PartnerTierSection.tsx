    ...
    <section className="relative overflow-hidden bg-[url('/images/partner/Benefit_bg.png')] bg-cover bg-center px-5 py-10 animate-fade-in">
      <div className="relative mx-auto max-w-[1320px]">
        <div className="mb-8 text-center">
          ...
          <p className="mt-6 text-2xl font-normal text-white/85 max-md:text-lg max-sm:text-base">Công cụ quản lý & phát triển cộng đồng affiliate tối ưu dành cho Partner của SCEX</p>
        </div>
        <div className="rounded-[20px] bg-[#0c0c0c] p-8 max-sm:p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)]">
          <h2 className="mb-8 text-center text-4xl font-medium max-md:text-2xl max-sm:text-xl">Các đặc quyền của đối tác</h2>
