...
export function AccountInfoCard({ rows }: AccountInfoCardProps) {
  return (
    <Card className="lg:col-span-2 bg-surface-1 border-border">
      ...
      <CardContent>
        <div className="grid gap-4 sm:grid-cols-2">
          {rows.map((row) => (
            <div key={row.label} className="rounded-lg border border-border-strong/70 bg-surface-0/80 px-4 py-3">
