...
export default function TierCard({ tier, onOffsetChange }: TierCardProps) {
  return (
    <div
      ...
      <div className="px-4 flex items-center gap-3">
        ...
        <div className="flex flex-col">
          ...
          <span className="text-sm italic font-normal text-white leading-[21px]">
            {tier.range} thành viên · {tier.kolCount} KOL
          </span>
        </div>
      </div>

      {/* Offset control - Pushed to bottom of card with flush bottom corners */}
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="w-8 h-8 flex items-center justify-center rounded-lg border border-[#545454] hover:border-[#828283] transition-colors"
