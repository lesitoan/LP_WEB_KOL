...
export default function TopLeaderboardCard({ entry, rewards, rankingType }: Props) {
  ...
  return (
    <div className={`relative w-full p-[1.5px] rounded-[18px] bg-gradient-to-b ${config.border}`}>
      <div className={`relative overflow-hidden bg-[#1C1C1E] rounded-[16px] p-4 ${heightClass} flex flex-col justify-between`}>
        ...
        <div className="relative z-10 flex items-center justify-between gap-3">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[11px] text-[#8B8B93] mt-0.5 truncate">
        ...
        <div className="relative z-10">
          ...
          <div className="flex justify-between items-end gap-3">
            <div className="min-w-0">
              <p className="text-[11px] text-[#8B8B93] mb-1 truncate">
