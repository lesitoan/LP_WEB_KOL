...
export default function TierHeroCard() {
  ...
  return (
    ...
    >
      <div className="rounded-[14px] bg-[#171717] p-3 sm:p-4 md:p-5">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-stretch lg:gap-3 xl:gap-5">
          <div className="grid shrink-0 grid-cols-[0.8fr_1.25fr_0.58fr] divide-x divide-[#262626] sm:grid-cols-[0.9fr_1.35fr_0.75fr] md:w-auto lg:max-w-[46%] xl:max-w-none">
          ...
          <div className="flex min-w-0 flex-1 flex-col justify-center rounded-lg bg-white/[0.06] p-3 backdrop-blur-[20px] sm:p-4">
            <div className="mb-3 flex shrink-0 items-start justify-between gap-4 text-base sm:text-xl">
              <div>
                <strong className="font-semibold text-[#D4A74A]">{activeMemberCount}</strong>
                {nextTier ? (
            ...
            {nextTier ? (
              <p className="text-sm font-medium leading-[18px] text-zinc-200 sm:text-base sm:leading-5">
                Bạn còn{' '}
                <span className="font-medium text-brand-bright">{membersNeeded}</span> active members để lên
                hạng{' '}
                <span className="font-bold text-[#D4A74A]">
