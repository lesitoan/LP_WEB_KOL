...
export function GroupBenefitsScreen({ groupId }: GroupBenefitsScreenProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-surface-card border border-border rounded-card overflow-hidden relative">
        {!isGroupLoading && !isBenefitsLoading && benefitItems.length === 0 ? (
          <div className="px-6 py-16 text-center space-y-3">
            <div className="mx-auto w-10 h-10 rounded-full bg-surface-control/50 border border-border grid place-items-center text-muted-foreground">
