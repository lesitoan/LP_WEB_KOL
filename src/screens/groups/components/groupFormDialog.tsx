        ...
        <form noValidate onSubmit={handleSubmit(onSubmit)} className="flex max-h-[92vh] flex-col">
          ...
          <div className="flex-1 overflow-y-auto overflow-x-hidden px-4 py-4 sm:px-6 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
            <FieldGroup className="gap-4">
              ...
              <div className="grid gap-4 lg:grid-cols-2">
                <Field orientation="vertical" className="gap-1">
                  <FieldLabel className="text-sm font-medium text-zinc-300">{`Ngưỡng volume tối thiểu (VNĐ/30 ngày)`}</FieldLabel>
                  <Input
                    className="h-10 border-border-strong bg-surface-1 text-sm font-normal text-foreground placeholder:font-normal placeholder:text-[#6E6E6E]"
                    type="number"
                    min={0}
                ...
                <Field orientation="vertical" className="gap-1">
                  <FieldLabel className="text-sm font-medium text-zinc-300">{`Ngưỡng volume tối đa (VNĐ/30 ngày)`}</FieldLabel>
                  <Input
                    className="h-10 border-border-strong bg-surface-1 text-sm font-normal text-foreground placeholder:font-normal placeholder:text-[#6E6E6E]"
                    type="text"
