...
import { useLoginMutation, useVerifyTwoFactorLoginMutation } from '@/services/api/authApi'
import { writeAuthSession } from '@/lib/authSession'
import { useAuthSession } from '@/hooks/useAuthSession'
import type { LoginAttemptResponse, TwoFactorChallenge } from '@/types/api'
...
const isTwoFactorChallenge = (value: LoginAttemptResponse): value is TwoFactorChallenge => {
...
function LoginForm() {
  ...
  const [verifyTwoFactorLogin, { isLoading: isVerifyingTwoFactor }] = useVerifyTwoFactorLoginMutation()
  ...
  const finishLogin = (result: Exclude<LoginAttemptResponse, TwoFactorChallenge>) => {
