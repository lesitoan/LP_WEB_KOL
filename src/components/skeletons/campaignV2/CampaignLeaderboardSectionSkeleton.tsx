  ...
  return (
    <div className="animate-pulse">
      <div className="flex flex-col items-center mb-6">
        <div className="h-7 w-40 rounded bg-white/10 mb-4" />
        <div className="h-10 w-72 rounded-full bg-white/10" />
      </div>

      <div className="grid grid-cols-1 min-[576px]:grid-cols-3 gap-2 mb-6">
        <TopLeaderboardCardSkeleton />
        <TopLeaderboardCardSkeleton />
        <TopLeaderboardCardSkeleton />
      </div>

      <div className="w-full bg-[#171717] rounded-2xl border border-white/5 overflow-hidden py-3">
