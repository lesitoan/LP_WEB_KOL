        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-stretch">
          <div className="grid shrink-0 grid-cols-3 divide-x divide-[#262626]">
            {[0, 1, 2].map((col) => (
              <div
                key={col}
                className="flex flex-col items-center justify-center gap-1.5 px-2 py-2 md:gap-2 md:px-4 md:py-3"
              >
          ...
          <div className="flex min-w-0 flex-1 flex-col justify-center space-y-3 rounded-lg bg-white/[0.06] p-4 backdrop-blur-[20px]">
