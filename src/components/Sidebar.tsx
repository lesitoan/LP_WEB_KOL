...
const icons: Record<string, JSX.Element> = {
  ...
  dollar: (
    ...
    >
      ...
      <path d="M12 7v10M9 9.5h4.5a1.5 1.5 0 0 1 0 3H9.5a1.5 1.5 0 0 0 0 3H14" />
    </svg>
  ),
  trophy: (
    <svg
      ...
      strokeWidth={1.8}
    >
      <path d="M8 21h8M12 17v4M6 4h12v6a6 6 0 0 1-12 0V4z" />
...
const cashbackSubItems = [
  ...
  {
    title: "Configs",
    href: "/cashback?tab=configs",
    tab: "configs",
    icon: "settings",
  },
  {
    title: "Cycles",
    href: "/cashback?tab=cycles",
    tab: "cycles",
    icon: "refresh",
  },
  {
    title: "Payouts",
    href: "/cashback?tab=payouts",
    tab: "payouts",
    icon: "wallet",
  },
];
...
export default function Sidebar({ onItemClick }: SidebarProps) {
  ...
  const [isCashbackOpen, setIsCashbackOpen] = useState(
    pathname === "/cashback",
  );
    ...
    <aside className="bg-surface-1 border-r border-border flex h-dvh min-h-dvh flex-col py-5 w-[232px] shrink-0 overflow-y-auto">
      <div className="px-5 pb-6 flex items-center gap-3">
        ...
        <div>
          ...
          <div className="text-[10px] text-muted-foreground font-normal tracking-widest uppercase">
            by GFI x SCEX
          </div>
        </div>
      </div>
